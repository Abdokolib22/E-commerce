...
export default function AllProduect() {
...
function getAllProduect(){
  return  axios.get(`https://ecommerce.routemisr.com/api/v1/products`)
}
let {isLoading , data } =useQuery('AllProduect',getAllProduect,{
    enabled:true
})
  ...
  return <>
  {
    isLoading?<div className={style.Pro}>
    ...
    <div className="row">
  
        {
            data?.data.data.map((produect)=><div key={produect.id} className='col-md-2'>
                <Link to={`/produectdetials/${produect.id}`}>
